import { c as create_ssr_component, b as compute_rest_props, a as setContext, d as spread, e as escape_object, f as escape_attribute_value, g as add_attribute, i as is_void, n as noop, v as validate_component, h as getContext } from "../../chunks/index.js";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Navbar, "Navbar").$$render(
    $$result,
    {
      navClass: "absolute top-0 end-0",
      color: "none"
    },
    {},
    {
      default: ({ hidden }) => {
        return `${validate_component(NavUl, "NavUl").$$render($$result, { hidden, nonActiveClass: "" }, {}, {
          default: () => {
